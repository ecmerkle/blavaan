...
Ordinal SEM is associated with two types of model parameterizations: *delta* and *theta*. These refer to scale parameters of the $y^*$ variables: *delta* refers to the total standard deviation of $y^*$ (including variability due to latent variables), and *theta* refers to the residual standard deviation of $y^*$. 

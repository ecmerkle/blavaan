...
ROPE is sensitive to scale, so be aware that the value of interest is representative in the respective scale. For this, standardized parameters are useful to have in a commonly used scale.
